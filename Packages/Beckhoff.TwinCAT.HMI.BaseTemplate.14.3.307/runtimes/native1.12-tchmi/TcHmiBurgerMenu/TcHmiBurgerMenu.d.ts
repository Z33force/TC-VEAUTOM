...
declare class TcHmiBurgerMenu extends TcHmi.Controls.Beckhoff.TcHmiToggleButton {
    #private;
    /**
    ...
    protected __targetControl: TcHmiControl.Control | null | undefined;
    ...
    protected __targetControlSave: TcHmiControl.Control | null | undefined;
     ...
     */
    setTargetControl(valueNew: TcHmiControl.Control | null): void;
    /**
     * Returns the current targetControl value.
     */
    getTargetControl(): TcHmiControl.Control | null | undefined;
    __processTargetControl(): void;
}
export { TcHmiBurgerMenu as Control };
